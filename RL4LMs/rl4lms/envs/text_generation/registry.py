...
from rl4lms.data_pools.custom_pool import InstructionData
from rl4lms.data_pools.custom_pool import  DefactoData
...
from rl4lms.envs.text_generation.custom_reward import GPTSummRewardFunction,GPTSummBatchedRewardFunction
from rl4lms.envs.text_generation.custom_metric import GPTROUGEMetric

class DataPoolRegistry:
    _registry = {
        "dummy_pool": TextGenPool,
        "imdb": IMDB,
        "commongen": CommonGen,
        "totto": ToTTo,
        ...
        'defacto_instruction': DefactoData
    }
...
class RewardFunctionRegistry:
    _registry = {
        ...
        "gpt_summ_reward": GPTSummRewardFunction,
        "gpt_summ_reward_batch": GPTSummBatchedRewardFunction
    }
